...
<main class="flex-1">
    ...
    <!-- Page hero -->
    <section class="relative overflow-hidden bg-slate-900" aria-labelledby="career-discussions-page-heading">
            ...
            <div class="rounded-lg bg-blue-600 px-6 py-8 sm:px-10">
                <div class="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                     ...
                     <a href="<?php echo htmlspecialchars(BASE_URL . '/career-discussion-create.php'); ?>" class="inline-flex shrink-0 items-center justify-center gap-2 rounded-lg bg-white px-6 py-3 text-sm font-semibold text-blue-700 transition-all duration-200 hover:bg-blue-50 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
            ...
            <?php else: ?>
                ...
                <ul class="mt-6 space-y-4">
                    <?php foreach ($ucsDiscussions as $ucsDiscussion): ?>
                        ...
                        ?>
                        <li class="rounded-lg bg-white p-5 shadow-sm ring-1 ring-slate-200 transition-all duration-200 hover:shadow-md sm:p-6">
                            ...
                            <h3 class="mt-3 text-lg font-bold leading-snug tracking-tight text-slate-900">
                            ...
                            <?php if ($ucsPreview !== ''): ?>
                                <p class="mt-2 text-sm leading-6 text-slate-600"><?php echo htmlspecialchars($ucsPreview); ?></p>
                            <?php endif; ?>

                            <div class="mt-4 flex flex-wrap items-center gap-x-5 gap-y-2 border-t border-slate-100 pt-4 text-xs text-slate-500">
