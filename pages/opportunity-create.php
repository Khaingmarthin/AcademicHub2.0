<?php
/**
 * Alumni self-management - share a career opportunity (protected).
 *
 * Only an authenticated, verified alumnus can share a career opportunity.
 * The posting is visible publicly as soon as it is created.
 */
...
$pageTitle    = 'Share a Career Opportunity';
$pageSubtitle = 'Share a real opening with the UCSMTLA community.';
...
$ucsForm = [
    ...
    'company'         => (string) ($ucsOld['company'] ?? ''),
    'location'        => (string) ($ucsOld['location'] ?? ''),
    'employment_type' => (string) ($ucsOld['employment_type'] ?? 'full_time'),
    'salary_range'    => (string) ($ucsOld['salary_range'] ?? ''),
    'description'     => (string) ($ucsOld['description'] ?? ''),
    'how_to_apply'    => (string) ($ucsOld['how_to_apply'] ?? ''),
    'expires_at'      => (string) ($ucsOld['expires_at'] ?? ''),
];

require_once __DIR__ . '/../includes/header.php';
?>
<main class="flex-1 bg-slate-50">
    <section class="py-12 sm:py-16" aria-labelledby="opportunity-create-heading">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap items-end justify-between gap-4">
                <div>
                    ...
                    <h1 id="opportunity-create-heading" class="mt-2 text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">Share a Career Opportunity</h1>
                    <p class="mt-2 max-w-xl text-sm leading-6 text-gray-600">
                        Post a job, internship or freelance opening. It will appear on the public Career Opportunities page immediately.
                    </p>
                </div>
            ...
            <div class="mt-8 overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-gray-200">
                <form method="post" action="<?php echo htmlspecialchars(ROOT_URL . '/actions/opportunity/create.php'); ?>" novalidate>
                    ...
                    <div class="space-y-6 px-6 py-6 sm:px-8">
                        <div class="grid gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" id="title" name="title" value="<?php echo htmlspecialchars($ucsForm['title']); ?>" placeholder="e.g. Junior Software Engineer" required maxlength="255"
                            ...
                            <div>
                                ...
                                <input type="text" id="company" name="company" value="<?php echo htmlspecialchars($ucsForm['company']); ?>" placeholder="e.g. Acme Ltd" required maxlength="255"
                                       class="mt-2 block w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 transition-colors focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-100">
                            </div>
                        </div>
                        ...
                        <div class="grid gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" id="location" name="location" value="<?php echo htmlspecialchars($ucsForm['location']); ?>" placeholder="e.g. Yangon / Remote" maxlength="191"
                                       class="mt-2 block w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 transition-colors focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-100">
                            </div>
                        </div>
                        ...
                        <div class="grid gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" id="salary_range" name="salary_range" value="<?php echo htmlspecialchars($ucsForm['salary_range']); ?>" placeholder="e.g. 800,000 – 1,200,000 MMK" maxlength="191"
                                       class="mt-2 block w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 transition-colors focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-100">
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="6" placeholder="Describe the role, responsibilities and requirements…" required
                        ...
                        <div>
                            ...
                            <textarea id="how_to_apply" name="how_to_apply" rows="3" placeholder="e.g. Send your CV to careers@example.com with the subject line \"Junior Engineer\"" 
