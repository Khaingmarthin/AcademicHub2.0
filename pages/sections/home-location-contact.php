 ...
 *
 * Clean two-column layout with map and contact details.
        ...
        <div class="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-12">
            ...
            <section aria-labelledby="campus-location-heading">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-[0.6875rem] font-semibold uppercase tracking-[0.2em] text-blue-600">Find Us</span>
                </div>
                <h2 id="campus-location-heading" class="mt-4 scroll-mt-24 text-3xl font-bold tracking-[-0.02em] text-gray-900">Campus Location</h2>
                <p class="mt-3 text-base leading-7 text-gray-600">
                    Find the university campus and plan your visit.
                </p>

                <div class="mt-6 overflow-hidden rounded-lg bg-gray-100">
                    <?php if ($ucsLocMapUrl !== ''): ?>
                        <iframe
                    ...
                    <?php else: ?>
                        <div class="flex h-72 items-center justify-center sm:h-80">
            ...
            <section aria-labelledby="location-contact-heading">
                <div class="flex items-center gap-3">
                    <span class="h-px w-8 bg-blue-600" aria-hidden="true"></span>
                    <span class="text-[0.6875rem] font-semibold uppercase tracking-[0.2em] text-blue-600">Contact</span>
                </div>
                <h2 id="location-contact-heading" class="mt-4 scroll-mt-24 text-3xl font-bold tracking-[-0.02em] text-gray-900">Contact Information</h2>
                <p class="mt-3 text-base leading-7 text-gray-600">
                ...
                <div class="mt-6 space-y-4">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm font-medium text-gray-900"><?php echo htmlspecialchars($ucsLocName); ?></p>
                        </div>
                    </div>
