 ...
 *   - list of ['key', 'label', 'url', 'icon', 'color', 'danger?']
 *
...
$ucsAdminNavItems = [
    [
        ...
        'color' => ['iconBg' => 'bg-blue-50', 'iconText' => 'text-blue-500', 'activeBg' => 'bg-blue-50', 'activeText' => 'text-blue-600', 'activeRing' => 'ring-blue-200', 'activeDot' => 'bg-blue-500'],
    ],
    [
        'key'   => 'news',
        'label' => 'News',
        ...
        'color' => ['iconBg' => 'bg-orange-50', 'iconText' => 'text-orange-500', 'activeBg' => 'bg-orange-50', 'activeText' => 'text-orange-600', 'activeRing' => 'ring-orange-200', 'activeDot' => 'bg-orange-500'],
    ],
    [
    ...
    [
        ...
        'color' => ['iconBg' => 'bg-emerald-50', 'iconText' => 'text-emerald-500', 'activeBg' => 'bg-emerald-50', 'activeText' => 'text-emerald-600', 'activeRing' => 'ring-emerald-200', 'activeDot' => 'bg-emerald-500'],
    ],
    [
        'key'   => 'classrooms',
        'label' => 'Classrooms',
    ...
    [
        ...
        'color' => ['iconBg' => 'bg-violet-50', 'iconText' => 'text-violet-500', 'activeBg' => 'bg-violet-50', 'activeText' => 'text-violet-600', 'activeRing' => 'ring-violet-200', 'activeDot' => 'bg-violet-500'],
    ],
    [
        'key'   => 'students',
        'label' => 'Students',
        ...
        'color' => ['iconBg' => 'bg-pink-50', 'iconText' => 'text-pink-500', 'activeBg' => 'bg-pink-50', 'activeText' => 'text-pink-600', 'activeRing' => 'ring-pink-200', 'activeDot' => 'bg-pink-500'],
    ],
    [
        'key'   => 'alumni',
        'label' => 'Alumni',
        ...
        'color' => ['iconBg' => 'bg-amber-50', 'iconText' => 'text-amber-500', 'activeBg' => 'bg-amber-50', 'activeText' => 'text-amber-600', 'activeRing' => 'ring-amber-200', 'activeDot' => 'bg-amber-500'],
    ],
    [
        'key'   => 'discussions',
        'label' => 'Discussions',
    ...
    [
        ...
        'color' => ['iconBg' => 'bg-fuchsia-50', 'iconText' => 'text-fuchsia-500', 'activeBg' => 'bg-fuchsia-50', 'activeText' => 'text-fuchsia-600', 'activeRing' => 'ring-fuchsia-200', 'activeDot' => 'bg-fuchsia-500'],
    ],
    [
        'key'    => 'logout',
        'label'  => 'Logout',
