...
<div class="mx-auto max-w-2xl">
    <div class="rounded-xl border border-slate-200 bg-white shadow-sm">
        <div class="border-b border-slate-100 px-6 py-5">
            <h2 class="text-base font-semibold text-slate-900">Edit Timetable</h2>
            <p class="mt-1 text-sm text-slate-500">Leave the image field empty to keep the current image. The timetable stays assigned to the active academic year.</p>
        </div>
            ...
            <div class="space-y-6 px-6 py-6">
                ...
                <div>
                    ...
                    <div class="mt-2 flex items-center gap-4">
                        <span class="inline-flex h-20 w-32 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-slate-100 ring-1 ring-slate-200" aria-hidden="true">
                ...
                <div>
                    <label for="image" class="block text-sm font-medium text-slate-700">Replace Image <span class="text-slate-400">(optional)</span></label>
