...
// Default the academic year to the currently Active one when none is posted.
...
<div class="mx-auto max-w-2xl">
    <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
        <div class="border-b border-gray-100 px-6 py-5">
            ...
            <p class="mt-1 text-sm text-gray-500">Select the academic year and major, then provide the course code and name.</p>
        </div>
