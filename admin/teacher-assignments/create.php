<?php
/**
 * Admin Teacher Course Assignments - create form.
 */
...
<div class="mx-auto max-w-2xl">
    <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
        <div class="border-b border-gray-100 px-6 py-5">
            <h2 class="text-base font-semibold text-gray-900">Assign Teacher</h2>
            <p class="mt-1 text-sm text-gray-500">Assign a teacher to teach a course to a specific classroom.</p>
        </div>

        <form method="post" action="<?php echo htmlspecialchars(ROOT_URL . '/actions/admin/teacher-assignment-create.php'); ?>" novalidate>
                ...
                <div>
                    ...
                    <select id="teacher_id" name="teacher_id" required
                        ...
                        <?php foreach ($ucsTeachers as $ucsTeacherOption): ?>
                            <option value="<?php echo (int) $ucsTeacherOption['id']; ?>" <?php echo (int) ($ucsOld['teacher_id'] ?? 0) === (int) $ucsTeacherOption['id'] ? 'selected' : ''; ?>>
                ...
                <div>
                    ...
                    <select id="course_id" name="course_id" required
                        ...
                        <?php foreach ($ucsCourses as $ucsCourseOption): ?>
                            <option value="<?php echo (int) $ucsCourseOption['id']; ?>" data-year-level="<?php echo htmlspecialchars($ucsCourseOption['year_level']); ?>" <?php echo (int) ($ucsOld['course_id'] ?? 0) === (int) $ucsCourseOption['id'] ? 'selected' : ''; ?>>
                ...
                <div>
                    ...
                    <select id="classroom_id" name="classroom_id" required
                        ...
                        <?php foreach ($ucsClassrooms as $ucsClassroomOption): ?>
                            <option value="<?php echo (int) $ucsClassroomOption['id']; ?>" data-year-level="<?php echo htmlspecialchars($ucsClassroomOption['year_level']); ?>" <?php echo (int) ($ucsOld['classroom_id'] ?? 0) === (int) $ucsClassroomOption['id'] ? 'selected' : ''; ?>>
