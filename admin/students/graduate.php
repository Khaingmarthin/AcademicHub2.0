...
<div class="mx-auto max-w-2xl">
    <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
        <div class="border-b border-gray-100 px-6 py-5">
            <h2 class="text-base font-semibold text-gray-900">Confirm Graduation</h2>
            <p class="mt-1 text-sm text-gray-500">This officially changes the student's academic status to <strong>Graduated</strong>. The student account and historical record remain intact.</p>
        </div>
        ...
        <div class="border-b border-gray-100 px-6 py-5">
            <dl class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                <div>
                    ...
                    <dd class="mt-1 text-sm font-semibold text-gray-900"><?php echo htmlspecialchars($ucsStudent['name']); ?></dd>
                </div>
                <div>
                    <dt class="text-xs font-semibold uppercase tracking-wider text-gray-500">Student ID</dt>
                    <dd class="mt-1 text-sm text-gray-700"><?php echo htmlspecialchars($ucsStudent['student_id']); ?></dd>
                </div>
                <div>
                    <dt class="text-xs font-semibold uppercase tracking-wider text-gray-500">Roll Number</dt>
                    <dd class="mt-1 text-sm text-gray-700"><?php echo htmlspecialchars($ucsStudent['roll_number']); ?></dd>
                </div>
                <div>
                    <dt class="text-xs font-semibold uppercase tracking-wider text-gray-500">Major</dt>
                    <dd class="mt-1 text-sm text-gray-700"><?php echo htmlspecialchars($ucsStudent['major_name']); ?></dd>
                </div>
                <div>
                    <dt class="text-xs font-semibold uppercase tracking-wider text-gray-500">Classroom</dt>
                    <dd class="mt-1 text-sm text-gray-700"><?php echo htmlspecialchars($ucsStudent['classroom_name'] . ($ucsStudent['academic_year'] !== '' && $ucsStudent['academic_year'] !== null ? ' — ' . $ucsStudent['academic_year'] : '')); ?></dd>
                </div>
                <div>
                    <dt class="text-xs font-semibold uppercase tracking-wider text-gray-500">Academic Status</dt>
                    <dd class="mt-1">
        ...
        <form method="post" action="<?php echo htmlspecialchars(ROOT_URL . '/actions/admin/student-graduate.php'); ?>" novalidate>
            ...
            <div class="space-y-6 px-6 py-6">
                <div>
                    <label for="graduation_year" class="block text-sm font-medium text-gray-700">Graduation Year <span class="text-red-500">*</span></label>
                    ...
                    <p class="mt-1.5 text-xs text-gray-500">The academic year in which this student completed the required programme.</p>
                </div>
            </div>
