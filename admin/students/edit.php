        ...
        <form method="post" action="<?php echo htmlspecialchars(ROOT_URL . '/actions/admin/student-update.php'); ?>" novalidate>
            ...
            <div class="space-y-6 px-6 py-6">
                ...
                <div>
                    ...
                    <?php if (($ucsForm['status'] ?? '') === 'graduated'): ?>
                        <form method="post" action="<?php echo htmlspecialchars(ROOT_URL . '/actions/admin/student-ungraduate.php'); ?>" class="mt-2" onsubmit="return confirm('Change this student back to active status?');">
                            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars(admin_csrf_token()); ?>">
                            <input type="hidden" name="student_id" value="<?php echo (int) $ucsId; ?>">
                            <button type="submit" class="inline-flex items-center gap-1.5 text-xs font-semibold text-red-600 transition-colors hover:text-red-700">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path></svg>
                                Change to Active Student
                            </button>
                        </form>
                    <?php endif; ?>
