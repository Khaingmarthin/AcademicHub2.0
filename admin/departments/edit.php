<?php
/**
 * Admin Departments module - edit form.
 */
...
$ucsOld = $_SESSION['department_old'] ?? null;
    ...
    <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
        ...
        <form method="post" action="<?php echo htmlspecialchars(ROOT_URL . '/actions/admin/department-update.php'); ?>" novalidate>
            ...
            <div class="flex flex-col-reverse gap-3 border-t border-gray-100 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
                <a href="<?php echo htmlspecialchars(ROOT_URL . '/admin/departments/index.php'); ?>" class="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 transition-colors duration-150 hover:bg-gray-50 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-400">
                    Cancel
                </a>
                <button type="submit"
