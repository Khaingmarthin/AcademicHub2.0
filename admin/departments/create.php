...
<div class="mx-auto max-w-2xl">
    <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
        <div class="border-b border-gray-100 px-6 py-5">
            <h2 class="text-base font-semibold text-gray-900">New Academic Department</h2>
        ...
        <form method="post" action="<?php echo htmlspecialchars(ROOT_URL . '/actions/admin/department-create.php'); ?>" novalidate>
            ...
            <div class="space-y-6 px-6 py-6">
                <div>
                    ...
                    <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($ucsOld['name'] ?? ''); ?>" placeholder="e.g. Department of Natural Language" required maxlength="255"
