        ...
        <div class="w-full max-w-md">
            <div class="admin-card rounded-2xl bg-white p-8 shadow-2xl shadow-black/10 ring-1 ring-slate-900/5 sm:p-10">
                ...
                <div class="text-center">
                    ...
                    <h1 class="mt-2 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Admin Sign In</h1>
                ...
                <form action="<?php echo htmlspecialchars(ROOT_URL . '/actions/admin/login.php'); ?>" method="post" class="mt-8 space-y-5" novalidate>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo htmlspecialchars(ROOT_URL . '/admin/forgot-password.php'); ?>" class="text-sm font-semibold text-blue-600 transition-colors hover:text-blue-700 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
                            Forgot password?
                        </a>
                    </div>
            ...
            <p class="mt-2 text-center text-xs text-gray-500">&copy; <?php echo date('Y'); ?> <?php echo htmlspecialchars(APP_NAME); ?></p>
        </div>
    </div>
