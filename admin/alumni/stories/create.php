<?php
/**
 * Admin Alumni Stories module - create form.
 */
...
$pageTitle    = 'Add Alumni Story';
$pageSubtitle = 'Write a new story highlighting a graduate experience or career journey.';
$activeNav    = 'alumni';
...
$ucsForm = [
    'alumni_profile_id' => $ucsOld['alumni_profile_id'] ?? '',
    'title'             => $ucsOld['title'] ?? '',
    'career_field'      => $ucsOld['career_field'] ?? '',
    'publication_date'  => $ucsOld['publication_date'] ?? '',
...
<div class="mx-auto max-w-3xl">
    <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
        <div class="border-b border-gray-100 px-6 py-5">
            <h2 class="text-base font-semibold text-gray-900">New Alumni Story</h2>
        ...
        <form method="post" action="<?php echo htmlspecialchars(ROOT_URL . '/actions/admin/alumni-story-create.php'); ?>" enctype="multipart/form-data" novalidate>
